...
ETC_5_dic = {'type': 'type_2', 'coin_No': 'KRW-ETC', 'coin_Name': 'KRW-ETC', 'ma_duration_long': 101, 'ma_duration_mid': 30, 'ma_duration_short': 74, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 47, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.74, 'ratio_open_check': 1.0027, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.996, 'ratio_mean_long': 0.5, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 'KRW-BTG', 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 34, 'ma_duration_short': 56, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 7, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0, 'diff_vol_aver': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 9, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.74, 'ratio_open_check': 1.0035, 'ratio_reduced': 0.8, 'ratio_prior_to_cur_long': 0.994, 'ratio_mean_long': 0.1, 'ratio_sell_forced': 0.11, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 'KRW-ARK', 'coin_Name': 'KRW-ARK', 'ma_duration_long': 89, 'ma_duration_mid': 26, 'ma_duration_short': 65, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 45, 'recent_vol_duration': 13, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.75, 'ratio_open_check': 1.0029, 'ratio_reduced': 1.0, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.1, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 'KRW-WAXP', 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 102, 'ma_duration_mid': 21, 'ma_duration_short': 65, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 5, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0, 'diff_vol_aver': 0.5, 'under_long_duration': 48, 'recent_vol_duration': 8, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.0017, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.7, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 'KRW-QTUM', 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 76, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 12, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 47, 'recent_vol_duration': 9, 'sell_method_vol_cri': 3.0, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.0035, 'ratio_reduced': 0.9, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.2, 'ratio_sell_forced': 0.085, 'bought_state': 0, 'bought_price': 0.0}

#BCH_30_dic = {'type': 'type_2', 'coin_No': 'KRW-BCH', 'coin_Name': 'KRW-BCH', 'ma_duration_long': 99, 'ma_duration_mid': 29, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 10, 'ratio_ema_mid_long': 0.985, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0, 'diff_vol_aver': 1.0, 'under_long_duration': 50, 'recent_vol_duration': 10, 'sell_method_vol_cri': 2.5, 'ratio_peak_diff': 0.7, 'ratio_open_check': 1.002, 'ratio_reduced': 1.0, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.3, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 'KRW-BORA', 'coin_Name': 'KRW-BORA', 'ma_duration_long': 101, 'ma_duration_mid': 32, 'ma_duration_short': 60, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 11, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 8, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.68, 'ratio_open_check': 1.004, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.1, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}


# In[4]:


LIST_target = [BTC_0_dic, ETH_1_dic, STEEM_11_dic, ETC_5_dic, BTG_20_dic, ARK_14_dic, WAXP_57_dic, QTUM_9_dic, BORA_72_dic]
...
candle_count = round((60/time_unit) * 24 * 1000)
...
def type_2_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        if (time_elapse_bought > 1) and (DF_check_peak['volume'][-2] < (target_dic['sell_method_vol_cri'] * DF_check_peak.iloc[(-5) : -2]['volume'].mean())) and         ((DF_check_peak['ema_sell_ma_duration_1'][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['high'].idxmax()]['high']) < target_dic['ratio_peak_diff']) :
